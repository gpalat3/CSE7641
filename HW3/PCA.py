...
def pcaFunc(no_features, X, y, dataset, random_seed):
    ...
    print("Plotting % for dataset % ", title, dataset)
    plotVarCurves(no_features, variance, cum_variance, xlabel, ylabel, label1, label2, savefile)
