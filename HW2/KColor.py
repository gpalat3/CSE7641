...
def randomHillClimb(fitness_fn, problem_size):
    ...
    rhc = mlrose_hiive.RHCRunner(problem=problem, iteration_list=[1000], max_attempts=100, seed=99, restart_list=[0],
                                 experiment_name='RandomizedHillClimbing', output_directory='output/KColor/')
...
if __name__ == '__main__':
    ...
    fitness_fn = mlrose_hiive.MaxKColor(edges)
    problem_size = range(1, 7, 1)
    ...
    title, xlabel, ylabel = ['KColor - Fitness', 'Problem Size', 'Fitness']
    savefile = 'plots/KColor_Fitness_Problem_Size.png'
    plotCurves(problem_size, fitness_rhc, fitness_sa, fitness_ga, fitness_mimic, title, xlabel, ylabel, savefile)
    title, xlabel, ylabel = ['KColor - Time', 'Problem Size', 'Time']
    savefile = 'plots/KColor_Time_Problem_Size.png'
    plotCurves(problem_size, times_rhc, times_sa, times_ga, times_mimic, title, xlabel, ylabel, savefile)
    title, xlabel, ylabel = ['KColor - FEvals', 'Iteration', 'FEvals']
    savefile = 'plots/KColor_Iterations_FEvals.png'
