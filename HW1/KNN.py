...
if __name__ == '__main__':
    ...
    print("KNN Learning Time Dataset 1:", learn_tm_1_knn)
    print("KNN Query Time Dataset 1:", query_tm_1_knn)
    ...
    print("KNN Hypertuning Learning Time Dataset 1:", learn_tm_1_hyper_knn)
    print("KNN Hypertuning Query Time Dataset 1:", query_tm_1_hyper_knn)
    print("--------------------------------")
    ...
    print("KNN Learning Time Dataset 1:", learn_tm_2_knn)
    print("KNN Query Time Dataset 1:", query_tm_2_knn)
    ...
    print("KNN Hypertuning Learning Time Dataset 1:", learn_tm_2_hyper_knn)
    print("KNN Hypertuning Query Time Dataset 1:", query_tm_2_hyper_knn)
    print("--------------------------------")
    print("--------------------------------")
