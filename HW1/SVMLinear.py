...
def runCurves(C, class_weight, max_iter, kernel, X_train, y_train, dataset):
    ...
    savefile = 'plots/SVM_Validation_Curve_' + kernel + '_' + iter + '_' + dataset + '.png'
...
if __name__ == '__main__':
    ...
    y_pred_1_svm_l, y_pred_train_1_svm_l, learn_tm_1_svm_l, query_tm_1_svm_l, query_tm_train_1_svm_l, rmse_1_svm_l, rmse_train_1_svm_l = mlModel(
        clf, X_train_1, X_test_1, y_train_1, y_test_1)
    print('Getting scores for dataset 2 ')

    y_pred_2_svm_l, y_pred_train_2_svm_l, learn_tm_2_svm_l, query_tm_2_svm_l, query_tm_train_2_svm_l, rmse_2_svm_l, rmse_train_2_svm_l = mlModel(
    ...
    y_pred_1_hyper_svm_l, y_pred_train_1_hyper_svm_l, learn_tm_1_hyper_svm_l, query_tm_1_hyper_svm_l, query_tm_train_1_hyper_svm_l, rmse_1_hyper_svm_l, rmse_train_1_hyper_svm_l = mlModel(
        clf,
        X_train_1,
        X_test_1,
        y_train_1,
    ...
    print("--------------------------------")
    print("--------------------------------")
    print("SVM Linear Accuracy Dataset 1: Out Sample", metrics.accuracy_score(y_test_1, y_pred_1_svm_l))
    print("SVM Linear Accuracy Dataset 1: In Sample", metrics.accuracy_score(y_train_1, y_pred_train_1_svm_l))
    print("SVM Linear Learning Time Dataset 1:", learn_tm_1_svm_l)
    print("SVM Linear Query Time Dataset 1:", query_tm_1_svm_l)
    print("SVM Linear Hypertuning Accuracy Dataset 1: Out Sample", metrics.accuracy_score(y_test_1, y_pred_1_hyper_svm_l))
    print("SVM Linear Hypertuning Accuracy Dataset 1: In Sample", metrics.accuracy_score(y_train_1, y_pred_train_1_hyper_svm_l))
    print("SVM Linear Hypertuning RMSE Dataset 1: Out Sample", rmse_1_hyper_svm_l)
    print("SVM Linear Hypertuning RMSE Dataset 1: In Sample", rmse_train_1_hyper_svm_l)
    print("SVM Linear Hypertuning Learning Time Dataset 1:", learn_tm_1_hyper_svm_l)
    print("SVM Linear Hypertuning Query Time Dataset 1:", query_tm_1_hyper_svm_l)
    print("--------------------------------")
    print("--------------------------------")
    ...
    clf = SVC(random_state=99, C=C, class_weight=class_weight, max_iter=max_iter, kernel=kernel)
    y_pred_2_hyper_svm_l, y_pred_train_2_hyper_svm_l, learn_tm_2_hyper_svm_l, query_tm_2_hyper_svm_l, query_tm_train_2_hyper_svm_l, rmse_2_hyper_svm_l, rmse_train_2_hyper_svm_l = mlModel(
        clf,
        X_train_2,
        X_test_2,
        y_train_2,
    ...
    print("SVM Linear Accuracy Dataset 2: Out Sample", metrics.accuracy_score(y_test_2, y_pred_2_svm_l))
    print("SVM Linear Accuracy Dataset 2: In Sample", metrics.accuracy_score(y_train_2, y_pred_train_2_svm_l))
    print("SVM Linear Learning Time Dataset 2:", learn_tm_2_svm_l)
    print("SVM Linear Query Time Dataset 2:", query_tm_2_svm_l)
    print("SVM Linear Hypertuning Accuracy Dataset 2: Out Sample", metrics.accuracy_score(y_test_2, y_pred_2_hyper_svm_l))
    print("SVM Linear Hypertuning Accuracy Dataset 2: In Sample", metrics.accuracy_score(y_train_2, y_pred_train_2_hyper_svm_l))
    print("SVM Linear Hypertuning RMSE Dataset 2: Out Sample", rmse_2_hyper_svm_l)
    print("SVM Linear Hypertuning RMSE Dataset 2: In Sample", rmse_train_2_hyper_svm_l)
    print("SVM Linear Hypertuning Learning Time Dataset 2:", learn_tm_2_hyper_svm_l)
    print("SVM Linear Hypertuning Query Time Dataset 2:", query_tm_2_hyper_svm_l)
    print("--------------------------------")
    print("--------------------------------")
...
--------------------------------
SVM Linear Accuracy Dataset 1: Out Sample 0.697495183044316
SVM Linear Accuracy Dataset 1: In Sample 0.7138130686517783
SVM Linear Learning Time Dataset 1: 0.01566171646118164
SVM Linear Query Time Dataset 1: 0.015626907348632812
SVM Linear Hypertuning Accuracy Dataset 1: Out Sample 0.7533718689788054
SVM Linear Hypertuning Accuracy Dataset 1: In Sample 0.7444168734491315
SVM Linear Hypertuning RMSE Dataset 1: Out Sample 0.6968135568055324
SVM Linear Hypertuning RMSE Dataset 1: In Sample 0.7360503093533011
SVM Linear Hypertuning Learning Time Dataset 1: 0.03126668930053711
SVM Linear Hypertuning Query Time Dataset 1: 0.0
--------------------------------
SVM Linear Accuracy Dataset 2: Out Sample 0.2342102569352032
SVM Linear Accuracy Dataset 2: In Sample 0.231002106002106
SVM Linear Learning Time Dataset 2: 2.047363042831421
SVM Linear Query Time Dataset 2: 0.528923749923706
...
SVM Linear Hypertuning Learning Time Dataset 2: 0.11251163482666016
SVM Linear Hypertuning Query Time Dataset 2: 0.04687023162841797
--------------------------------
--------------------------------
'''